...
//  CreateOutput()
//
//  Open stdout instead of WAV file
//
HRESULT CLoopbackCapture::CreateOutput()
{
    return SetDeviceStateErrorIfFailed([&]() -> HRESULT
        {
            if (m_streamToStdout)
            {
                ...
                RETURN_LAST_ERROR_IF(m_hStdout == INVALID_HANDLE_VALUE || m_hStdout == NULL);
                return S_OK;
            }
...
HRESULT CLoopbackCapture::StartCaptureToStdoutAsync(DWORD processId, bool includeProcessTree)
{
    m_streamToStdout = true;
